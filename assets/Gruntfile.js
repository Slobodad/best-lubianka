...
grunt.initConfig({
	...
	// 	dist: {
	// 		files: {
	// 			'markup/css/style.min.css': 'style.min.css'
	// 		}
	// 	}
	// },
	...
	uglify: {
		dist: {
			files: {
				...
				'../markup/js/mCustomScrollbar.min.js': ['dist/js/plugin/mCustomScrollbar.js'],
				'../markup/js/fancybox.min.js': ['dist/js/plugin/fancybox.js'],
				'../markup/js/maskedinput.min.js': ['dist/js/plugin/maskedinput.js'],
